# Plan 30 — Remote MCP for Everyone (CAR-13)
...
connector" → `https://www.careervine.app/api/mcp` → browser opens CareerVine's
...
- **Claude Code**: `claude mcp add --transport http careervine
  https://www.careervine.app/api/mcp`, then `/mcp` → browser OAuth. Uses an
...
### Phase 1 — Flip the code dependency direction (no behavior change) ✅ done 2026-07-09
