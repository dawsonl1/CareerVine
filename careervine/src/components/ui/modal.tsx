 ...
 *
 * The composition claim above is scoped to TAB (CAR-204). ESCAPE is a
 * document-level listener here and another in `confirm-dialog.tsx`, neither of
 * which stops propagation or asks whether it is the top layer, so a `useConfirm`
 * dialog opened over an open Modal would have one Escape close both. Nothing
 * does that today, but the wording generalized to a third dialog family it was
 * not written for.
 */
