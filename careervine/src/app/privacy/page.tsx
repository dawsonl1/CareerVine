          ...
          <section>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              ...
              <div>
                ...
                <p className="mt-2"><span className="font-medium text-foreground">Suggesting new people:</span> for discovery features, we collect publicly available profile information (such as name, headline, location, current role, and photo) for people who are not yet your contacts, for example recent hires in relevant roles at companies you follow, and store it as suggestions in your account. A suggestion you dismiss is hidden from your feed but kept as part of your account until you delete your account. The curated contact lists you can subscribe to are built from the same kind of publicly available professional information, which can include professional email addresses.</p>
