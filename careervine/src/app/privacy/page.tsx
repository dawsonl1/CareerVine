        ...
        <div className="prose prose-sm max-w-none space-y-8 text-foreground">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed">
              ...
              <li>To read delivery failure notices in your mailbox so we can flag an address that has stopped accepting mail, cancel anything still queued to it, and email you about it. Each of these emails can be turned off individually in your settings or through the unsubscribe link in the email itself</li>
